const committeesData = [
    { name: "UNSC", full: "United Nations Security Council", logo: "assets/UNSC.png", agenda: "\"The Great War Of Africa\" · Freeze: Aug 2, 1998", eb: [{ name: "", role: "Chairperson", img: "assets/MUNchair26/"},{ name: "", role: "Vice Chairperson", img: "assets/MUNchair26/"}] },
    ...
    { name: "ECOSOC", full: "Economic & Social Committee", logo: "assets/ECOSOC.png", agenda: "Post-2030 Development Agenda", eb: [ {name: "Chairperson", role: "TBA", img: "https://placehold.co/100x100/6b3bc9/white?text=ECOSOC"},{ name: "Grhitha Sahu", role: "Vice Chairperson", img: "assets/MUNchair26/Grhitha Sahu_Vice Chair_ECOSOC.jpeg"}] },
    { name: "UNEP", full: "United Nations Environment Programme", logo: "assets/UNEP.png", agenda: "Combating Plastic Pollution Across Global Ecosystem", eb: [{ name: "B Bhargav", role: "Chairperson", img: "assets/MUNchair26/Bharghav_UNEP_Chair.jpg"},{ name: "Vedesh", role: "Vice Chair", img: "assets/MUNchair26/Vedesh_Vice chair_ UNEP.jpg"}] },
    { name: "WHO", full: "World Health Organization", logo: "assets/WHO.png", agenda: "Addressing long-term health impacts of biological weaponry", eb: [{ name: "Manasa Aravind", role: "Chairperson", img: "assets/MUNchair26/Manasa Aravind_ Chair_ WHO.jpg"},{ name: "thanushree", role: "Vice Chairperson", img: "assets/MUNchair26"}] },
    ...
    { name: "COPUOS", full: "Committee on Peaceful Uses of Outer Space", logo: "assets/COPUOS.png", agenda: "Developing International Frameworks For Space Traffic Management", eb: [{ name: "B Pranav", role: "Chairperson", img: "assets/MUNchair26"},{ name: "Madhu Sandhana", role: "Vice Chair", img: "assets/MUNchair26/MADHU SANDHANA.I _ VICE CHAIR _ COPUOS.jpg"}] },
    ...
    { name: "UNFCCC", full: "United Nations Framework Convention on Climate Change", logo: "assets/UNFCCC.png", agenda: "The Climate Refugee Crisis: Bridging the Legal Gap in Human Mobility", eb: [{ name: "Arunima Ranjan Sinha", role: "Chairperson", img: "assets/MUNchair26/Arunima Ranjan Sinha-Chairperson-UNFCCC.jpeg"},{ name: "Jigisha Madhan", role: "Vice Chair", img: "assets/MUNchair26/Jigisha Madhan-UNFCCC vice chair .jpg"}] },
    ...
    { name: "SOCHUM", full: "Social Cultural and Humanitarian Committee", logo: "assets/SOCHUM.png", agenda: "Deliberation on deteriorating human rights associated with immigration and forced migration", eb: [{ name: "Swayam Krishnan", role: "Chairperson", img: "assets/MUNchair26/SWAYAM KRISHNAN_CHAIR_SOCHUM.png"},{ name: "", role: "Vice Chairperson", img: "assets/MUNchair26"}] },
    { name: "UNOCT", full: "United Nations Office on Counter Terrorism", logo: "assets/", agenda: "The Pahalgam Tragedy", eb: [{ name: "Chairperson", role: "TBA", img: "assets/MUNchair26"},{ name: "Vice Chairperson", role: "TBA", img: "assets/MUNchair26"}] },
    { name: "IPP", full: "International Press Corps", logo: "assets/IPC.png", agenda: "Role of media in reporting international affairs", eb: [{ name: "Chairperson", role: "TBA", img: "assets/MUNchair26"},{ name: "Vice Chairperson", role: "TBA", img: "assets/MUNchair26"}] },
...
const featuredData =[
    ...
    { name: "NARCOS+", full: "FLAGSHIP COMMITTEE", logo: "assets/NARCOS.png", agenda: "The Extradition Question · 7th August 1982", eb: [{ name: "Crisis Director", role: "NARCOS+", img: "assets/MUNchair26/"},{ name: "Co-Director", role: "Operations", img: "https://placehold.co/100x100/ff3b6f/wh"}] },
    { name: "SPECPOL", full: "Special Political and Decolonization Committee", logo: "assets/OAS.png", agenda: "The Situation in Western Sahara · 29 April 1991", eb: [ { name: "Keshav puri", role: "Chairperson", img: "assets/MUNchair26/KESHAV PURI - CHAIR - OAS.png"}, { name: "Sai Smrithi", role: "Vice Chairperson", img: "assets/MUNchair26/Sai smrithi - vice chairperson- OAS.jpg"},{ name: "Praghathi Suresh", role: "Moderator", img: "assets/MUNchair26/Praghathi Suresh_Moderator_OAS.jpeg"}] }
];
